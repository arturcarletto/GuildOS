...
5. For ready and join handling, the adapter snapshots supported text and announcement channels from JDA's cache outside any database transaction, then persists the active set with idempotent upserts and marks missing channels inactive.
